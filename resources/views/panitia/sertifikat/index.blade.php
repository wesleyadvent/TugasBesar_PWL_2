                ...
                <div class="card mb-4 shadow-sm border-0">
                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Daftar Event yang Sudah Lewat</h6>
                        </div>
                    </div>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end px-2 py-3"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item border-radius-md"
                                                                href="{{ route('panitia.sertifikat.show', $event->id) }}">
                                                                <i class="fa fa-upload me-2"></i>Upload Sertifikat
                                                            </a>
                                                        </li>
                                                        ...
                                                        <div class="row g-4">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <ul class="list-unstyled fs-6">
                                                                    ...
                                                                    <li class="mb-3">
                                                                        <strong><i
                                                                                class="fa fa-clock text-primary me-2"></i>Waktu:</strong>
